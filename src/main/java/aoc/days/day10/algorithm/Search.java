package aoc.days.day10.algorithm;
...
public class Search {
    public static int bfs(Machine m) {
        int target = m.target();
    ...
    public static long dfs(Machine m) {
        int[] buttons = m.buttons();
    ...
    private static long dfs(int[] buttons, int[] cur, Map<String, Long> memo) {
